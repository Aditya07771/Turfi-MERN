...
export const register = async (req, res) => {
    ...
    try {
        ...
        const otpExpiry = Date.now() + 24 * 60 * 60 * 1000; // OTP expires in 24 hours
        ...
        return res.json({ success: true, message: "User registered successfully. Verification OTP sent to email." });
    } catch (error) {
